...
import com.viettel.vdt2023.gitlab.api.HookManager;
import com.viettel.vdt2023.gitlab.api.utils.HttpRequestUtils;
...
public class WebHookManager implements HookManager {
     ...
     * @throws  if the parsed event is not supported
     */
