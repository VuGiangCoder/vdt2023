...
import com.viettel.vdt2023.gitlab.api.models.Deployment;
import com.viettel.vdt2023.gitlab.api.models.DeploymentFilter;
import com.viettel.vdt2023.gitlab.api.models.MergeRequest;
...
public class DeploymentsApi extends AbstractApi {
     ...
     *
     * @param projectIdOrPath the project in the form of an Long(ID), String(path), or Project instance
     * @param filter  a DeploymentFilter instance with the filter settings
     * @return a Pager of Deployment
     * @throws GitLabApiException if any exception occurs
     */
