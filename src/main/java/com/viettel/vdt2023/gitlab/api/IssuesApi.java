...
import com.viettel.vdt2023.gitlab.api.utils.DurationUtils;
...
public class IssuesApi extends AbstractApi implements Constants {
     ...
     *
     * @param projectIdOrPath the project in the form of an Long(ID), String(path), or Project instance
     * @param filter a IssueFilter instance with the filter settings
     * @return the list of issues in the specified range.
     * @throws GitLabApiException if any exception occurs
     */
     ...
     *
     * @param projectIdOrPath the project in the form of an Long(ID), String(path), or Project instance
     * @param filter IssueFilter instance with the filter settings.
     * @param page the page to get.
