...
import com.viettel.vdt2023.gitlab.api.models.JobStatus;
import com.viettel.vdt2023.gitlab.api.models.Runner;
import com.viettel.vdt2023.gitlab.api.models.RunnerDetail;
...
public class RunnersApi extends AbstractApi {
     ...
     * @throws GitLabApiException if any exception occurs
     */
    public Pager<Runner> getAllRunners(Runner.RunnerType type, Runner.RunnerStatus status, int itemsPerPage)
