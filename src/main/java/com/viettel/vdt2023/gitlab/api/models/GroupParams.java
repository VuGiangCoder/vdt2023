...
public class GroupParams {
    ...
    public GroupParams(String name, String path, String description, String visibility, Boolean shareWithGroupLock,
                       Boolean requireTwoFactorAuthentication, Integer twoFactorGracePeriod,
                       ProjectCreationLevel projectCreationLevel, Boolean autoDevopsEnabled,
                       SubgroupCreationLevel subgroupCreationLevel, Boolean emailsDisabled, Boolean lfsEnabled,
                       Boolean requestAccessEnabled, Integer sharedRunnersMinutesLimit,
                       Integer extraSharedRunnersMinutesLimit, DefaultBranchProtectionLevel defaultBranchProtection) {
        this.name = name;
        this.path = path;
    ...
    public GroupParams(String name, String path){
        this.name=name;
        this.path = path;
    }
