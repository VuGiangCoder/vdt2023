...
import com.viettel.vdt2023.gitlab.api.utils.MaskingLoggingFilter;
...
public class GitLabApiClient implements AutoCloseable {
     ...
     *      bytes to be logged.  When logging if the maxEntitySize
    ...
    protected Invocation.Builder invocation(URL url, MultivaluedMap<String, String> queryParams, String accept) {
        ...
        String authHeader = (tokenType == Constants.TokenType.OAUTH2_ACCESS ? AUTHORIZATION_HEADER : PRIVATE_TOKEN_HEADER);
        String authValue = (tokenType == Constants.TokenType.OAUTH2_ACCESS ? "Bearer " + authToken.get() : authToken.get());
