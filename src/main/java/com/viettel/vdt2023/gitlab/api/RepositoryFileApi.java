...
import com.viettel.vdt2023.gitlab.api.models.Blame;
import com.viettel.vdt2023.gitlab.api.models.RepositoryFile;
...
public class RepositoryFileApi extends AbstractApi {
    ...
    public void deleteFile(Object projectIdOrPath, String filePath, String branchName, String commitMessage) throws GitLabApiException {
        ...
        Form form = new Form();
        addFormParam(form, isApiVersion(GitLabApi.ApiVersion.V3) ? "branch_name" : "branch",
