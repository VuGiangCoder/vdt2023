...
public class ExternalStatusCheckEvent {
    ...
    private IssueEvent.ObjectAttributes objectAttributes;
    ...
    public IssueEvent.ObjectAttributes getObjectAttributes() {
        return this.objectAttributes;
    }

    public void setObjectAttributes(IssueEvent.ObjectAttributes objectAttributes) {
