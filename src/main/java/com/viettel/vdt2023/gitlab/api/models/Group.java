...
public class Group extends AbstractGroup<Group> {
    ...
    public Group(String name, String path, String description, Visibility visibility, Boolean lfsEnabled, Boolean requestAccessEnabled, Long parentId) {
        this.name_of_system = name;
        this.path = path;
    ...
    public String getName_of_system() {
        return name_of_system;
    }

    public void setName_of_system(String name_of_system) {
        this.name_of_system = name_of_system;
    }
